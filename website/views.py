...
def home(request):
    lang_list = ['c', 'clike', 'cpp', 'csharp', 'css',
                 ...
                 'mongodb', 'objectivec', 'perl', 'php', 'powershell',
                 'python', 'r', 'regex', 'ruby', 'rust', 'sass', 'scala',
                 'sql', 'swift', 'yaml']
    ...
    if request.method == "POST":
        ...
        if lang == "Select Programming Language":
            ...
            # OpenAI Key
            openai.api_key = "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"
            ...
            try:
                response = openai.Completion.create(
                    ...
                    prompt=f"Respond only with code. Fix this {
                        lang} code: {code}",
                    temperature=0,
                    max_tokens=1000,
                    top_p=1.0,
...
def suggest(request):
    lang_list = ['c', 'clike', 'cpp', 'csharp', 'css',
                 ...
                 'matlab', 'mongodb', 'objectivec', 'perl',
                 'php', 'powershell', 'python', 'r', 'regex',
                 'ruby', 'rust', 'sass', 'scala', 'sql', 'swift', 'yaml']
